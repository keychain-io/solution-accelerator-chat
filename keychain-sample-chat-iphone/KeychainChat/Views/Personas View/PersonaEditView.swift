...
//  KeychainChat
//
//  Created by Robert Ellis on 11/16/22.
//
...
struct PersonaEditView: View {
    let log = Logger(label: PersonaEditView.typeName)
            ...
            HStack(alignment: .center) {
                ...
                Button("Save", action: {
                    if (name.trimmingCharacters(in: .whitespaces).count > 0 &&
                        ...
                        personaViewModel.renamePersona(persona: selectedPersona,
                                                       newName: name,
                                                       newSubName: subName)
...
struct PersonaEditView_Previews: PreviewProvider {
    static var previews: some View {
        PersonaEditView(isPresented: .constant(true),
                        name: "Billy",
                        subName: "Bobby",
                        selectedPersona: .constant(Persona()))
    }
}

extension PersonaEditView : TypeNameDescribable {}
